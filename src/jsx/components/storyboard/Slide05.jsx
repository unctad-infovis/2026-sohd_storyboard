...
const MAX_ICON_H = 200; // px — refined icon at full height
      ...
      <div className="slide_content" ref={ref}>
        ...
        <div className="chart_meta">
          <div className="source">
            <span className="label">Source:</span> UN Trade and Development (UNCTAD), based on UN Comtrade. Note: Figures correspond to the 65 net oil-importing vulnerable economies, excluding Singapore.
          </div>
        </div>
      </div>
    </div>
